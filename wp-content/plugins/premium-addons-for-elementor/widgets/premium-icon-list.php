		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-bullet-list-wrapper svg, {{WRAPPER}} {{CURRENT_ITEM}} .premium-bullet-list-wrapper svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$repeater_list->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} {{CURRENT_ITEM}} .premium-bullet-list-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}  {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-bullet-list-wrapper svg, {{WRAPPER}}  {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-bullet-list-wrapper svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$repeater_list->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-bullet-list-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-bullet-list-wrapper svg, {{WRAPPER}} .premium-bullet-list-wrapper svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-bullet-list-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-bullet-list-content:hover .premium-bullet-list-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
			...
			<li <?php echo wp_kses_post( $this->get_render_attribute_string( $list_content_key ) ); ?>>
				...
				<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'wrapper-' . $index ) ); ?>>
					...
					if ( 'icon' === $item['icon_type'] ) {
						...
						?>
						<div <?php echo wp_kses_post( $this->get_render_attribute_string( $animation_key ) ); ?>>
							<?php echo $this->print_unescaped_setting( 'custom_svg', 'list', $index ); ?>
						</div>
						<?php

		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-button-text-icon-wrapper svg, {{WRAPPER}} .premium-button-text-icon-wrapper svg *'   => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'premium_button_icon_switcher' => 'yes',
					'icon_type'                    => 'icon',
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-button-text-icon-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-button:hover .premium-button-text-icon-wrapper svg, {{WRAPPER}} .premium-button:hover .premium-button-text-icon-wrapper svg *'   => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'premium_button_icon_switcher' => 'yes',
					'icon_type'                    => 'icon',
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-button:hover .premium-button-text-icon-wrapper svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		if( 'yes' === settings.premium_button_icon_switcher ) {
			...
			if( 'icon' === iconType || 'svg' === iconType ) {
				...
				if( 'icon' === iconType ) {
					...
					var iconHTML = 'yes' !== settings.draw_svg ? elementor.helpers.renderIcon( view, settings.premium_button_icon_selection_updated, { 'class': 'premium-svg-nodraw', 'aria-hidden': true }, 'i' , 'object' ) : false,

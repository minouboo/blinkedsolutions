		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-progressbar-circle-content svg, {{WRAPPER}} .premium-progressbar-circle-content svg *' => 'fill: {{VALUE}}',
				),
				'condition' => array(
					'icon_type' => array( 'icon', 'svg' ),
				),
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-progressbar-circle-content svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}

		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-image-separator-container svg, {{WRAPPER}} .premium-image-separator-container svg *' => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'separator_type' => array( 'icon', 'svg' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-image-separator-container svg:hover, {{WRAPPER}} .premium-image-separator-container svg:hover *' => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'separator_type' => array( 'icon', 'svg' ),
				),
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-image-separator-container svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		<#
			...
			if( 'image' === type ) {
				...
				if( 'icon' === type && 'yes' !== settings.draw_svg ) {
					var iconHTML = elementor.helpers.renderIcon( view, settings.separator_icon, { 'class': 'premium-svg-nodraw', 'aria-hidden': true }, 'i' , 'object' );
				}
